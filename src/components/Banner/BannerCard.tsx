        ...
        <div className='rounded-2xl bg-black'>
            <div className='w-full flex items-center justify-between px-10'>
                <div className='space-y-4 py-5'>
                    <h1 className='text-md md:text-lg lg:text-xl text-orange-400'>Welcome Back <span className='bg-default-200/60 text-white rounded-lg px-7 capitalize '>{state?.profile?.userName}</span></h1>
