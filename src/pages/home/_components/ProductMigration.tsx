                    ...
                    (
                        <div className='w-full'>
                            <div className='border-b p-7 rounded-t-xl bg-[#F5F5F5]'>
                                <p className='text-black text-sm md:text-lg flex items-center'>
                                    {user?.applicationStatus === 'approved' ? 'What You Recieved in Homnifi' : 'What You Will Recieve in Homnifi'}
